...
<div class="row">
    ...
    <td>{{ $sed->Telefono }}</td>
    <td>
        <a href="{{URL::action('App\Http\Controllers\SedeController@edit',$sed->id)}}"><button class="btn btn-primary">Actualizar</button></a>
    <a href="" data-bs-toggle="modal" data-bs-target="#modal-delete-{{$sed->id}}">
